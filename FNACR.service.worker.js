...
/** @type {string} */
const CACHE_VERSION = '1741489833|2225105781';
/** @type {string} */
const CACHE_PREFIX = 'Five Nights at C-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'FNACR.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["FNACR.html","FNACR.js","FNACR.offline.html","FNACR.icon.png","FNACR.apple-touch-icon.png","FNACR.audio.worklet.js","FNACR.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["FNACR.wasm","FNACR.pck"];
